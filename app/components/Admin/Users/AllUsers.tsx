...
const AllCourses: FC<Props> = ({ isTeam }) => {
  ...
  const columns = [
    ...
    { field: "courses", headerName: "Purchased Courses", flex: 0.7 },
        ...
        <Box m="20px">
          {isTeam && (
            <div className="w-full flex justify-end">
              <div
                className={`${styles.button} !w-[200px] !rounded-[10px] dark:bg-[#57c7a3] !h-[35px] dark:border dark:border-[#ffffff6c] cursor-pointer`}
          ...
          <Box
            ...
            sx={{
              ...
              "& .MuiDataGrid-columnHeader": {
                backgroundColor: theme === "dark" ? "#3e4396" : "#efcca6",
                borderBottom: "none",
                color: theme === "dark" ? "#fff" : "#000",
              },
