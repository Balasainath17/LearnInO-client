    ...
    <div className="mt-[10px]">
      <div className="grid grid-cols-[75%,25%]">
        ...
        <div className="pt-[80px] pr-8">
          <div className="w-full dark:bg-[#111C43] bg-[#efcca6] rounded-sm shadow h-[20vh]">
          ...
          <div className="w-full dark:bg-[#111C43] bg-[#efcca6] rounded-sm shadow my-8 h-[20vh]">
            <div className="flex items-center p-5 justify-between">
              <div className="">
      ...
      <div className="grid grid-cols-[65%,35%] mt-[-20px]">
        <div className="dark:bg-[#111c43] bg-[#efcca6] w-[94%] mt-[30px] h-[35vh] shadow-sm m-auto">
          <OrdersAnalytics isDashboard={true} />
        </div>
        <div className="p-6 mt-[-20px]">
          <h5 className="dark:text-[#fff] text-black text-[18px] font-[700] font-Poppins pb-1">
            Recent Transactions
          </h5>
